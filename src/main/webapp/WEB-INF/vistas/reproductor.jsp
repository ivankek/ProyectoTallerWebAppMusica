		...
		<div class="row">
    		...
    		<div class="col-6">
      			<div class="play-icons text-white align-items-center d-flex justify-content-center">
        			...
        			<i class="material-icons ms-4 play" style="font-size:40px">play_circle_outline</i>
    		...
    		<div class="col-3 text-white d-inline-flex flex-row-reverse align-items-center">
      			...
      			<div class="ms-2"><i id="queue" class="material-icons">queue_music</i></div>
      			...
      			<div class="ms-2"><i class="material-icons chat">chat</i></div>
      		</div>
    	</div>
	</footer>