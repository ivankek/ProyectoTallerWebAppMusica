...
<div class="container-fluid main pb-4 mb-5">
	<div class="row">
		...
		<div class="col bg-dark bg-gradient p-5">
			...
			<h2 class="text-white mb-4">Artistas recomendados para vos</h2>
			<c:choose>
				<c:when test="${!condicion}">
					...
					<div class="row row-cols-1 row-cols-md-5 g-4">
						<c:forEach items="${recomendaciones}" var="recomendacion">
							<div class="col">
								<div class="card bg-dark text-white" style="height: 90%;">
									<img src="${recomendacion.path_img}" class="card-img-top"
										style="height: 70%; width: 100%; object-fit: cover; object-position: 50% 50%;"
										alt="nombrealbum"> <a
										class="text-decoration-none hover-focus text-light"
										href="Artista?nombre=${recomendacion.nombre}">
										<div class="card-body">
			...
			<h2 class="text-white mb-4">Top 5 Canciones</h2>
			<div class="row row-cols-1 row-cols-md-5 g-4">
